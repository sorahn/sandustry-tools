...
export function TextAction<T extends ElementType = "button">({
  ...
  const classes = cx(
    "inline-flex items-center gap-1.5 whitespace-nowrap text-sm text-[var(--sd-color-text,#ffffff)] transition-colors hover:text-[var(--sd-color-primary,#ffe700)] focus-visible:outline-2 focus-visible:outline-[var(--sd-color-primary,#ffe700)] focus-visible:outline-offset-2",
    className,
  );
