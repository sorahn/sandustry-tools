  ...
  return (
    <sandustry-search-input scale={size} class="inline-flex w-full">
      <input
        ...
        type="search"
        className={cx(
          "w-full rounded border border-[var(--sd-color-border,#2a323d)] bg-[var(--sd-color-surface-elevated,#181c20)] text-[var(--sd-color-text,#e8eef5)] placeholder:text-[var(--sd-color-text-subtle,#808080)] transition-colors focus:border-[var(--sd-color-primary,#ffe700)] focus:outline-none",
