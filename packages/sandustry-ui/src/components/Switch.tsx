    ...
    >
      <label className="contents cursor-pointer">
        ...
        <span
          aria-hidden="true"
          className={cx(
            "relative inline-flex shrink-0 items-center rounded-full bg-black ring-1 ring-inset ring-slate-700 transition-colors duration-200 peer-checked:bg-[var(--sd-color-primary,#ffe700)] peer-checked:ring-[var(--sd-color-primary,#ffe700)] peer-focus-visible:ring-2 peer-focus-visible:ring-[var(--sd-color-primary,#ffe700)]",
            size === "small" &&
